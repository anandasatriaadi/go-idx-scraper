...
func (r *AnnouncementRepository) Create(ctx context.Context, model *Announcement) (*mongo.InsertOneResult, error) {
...
func (r *AnnouncementRepository) FindByID(ctx context.Context, id primitive.ObjectID) (*Announcement, error) {
...
func (r *AnnouncementRepository) FindOne(ctx context.Context, filter bson.M) (*Announcement, error) {
	var model Announcement
...
func (r *AnnouncementRepository) UpdateByID(ctx context.Context, id primitive.ObjectID, update bson.M) (*mongo.UpdateResult, error) {
...
func (r *AnnouncementRepository) DeleteByID(ctx context.Context, id primitive.ObjectID) (*mongo.DeleteResult, error) {
...
func (r *AnnouncementRepository) FindOneAndUpdate(ctx context.Context, filter bson.M, update bson.M) (*Announcement, error) {
	var model Announcement
...
// update is the full update document, e.g., bson.M{"$set": fields} or bson.M{"$inc": ...}
func (r *AnnouncementRepository) Upsert(ctx context.Context, id primitive.ObjectID, update bson.M) (*mongo.UpdateResult, error) {
...
func (r *AnnouncementRepository) FindAll(ctx context.Context, filter bson.M) ([]*Announcement, error) {
...
func (r *AnnouncementRepository) FindPage(ctx context.Context, filter bson.M, page int64, limit int64, sort interface{}) ([]*Announcement, int64, error) {
	skip := (page - 1) * limit
	if skip < 0 {
		skip = 0
	}
